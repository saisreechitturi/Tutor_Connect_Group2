...
export const users = [
    ...
    {
        id: 5,
        email: "maatheswaran@example.com",
        username: "maatheswaran_tutor",
        password: "demo",
        role: "tutor",
        profile: {
            firstName: "Maatheswaran Kannan",
...
export const currentUser = users[0]; // Sai Prathyusha (student)