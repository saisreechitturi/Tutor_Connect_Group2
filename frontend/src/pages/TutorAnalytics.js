...
import { Calendar, DollarSign, Clock, Users, TrendingUp, TrendingDown, Star, BookOpen, Target, Award } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <StatCard
                    ...
                    subtitle="This month"
                    trend="up"
                    trendValue={analyticsData.earnings.growth}
                    color="green"
                />
                <StatCard
                    icon={Clock}
                ...
                <StatCard
                    ...
                    subtitle={`${analyticsData.students.retention}% retention rate`}
                    color="purple"
                />
                <StatCard
                    icon={Star}
                ...
                <StatCard
                    ...
                    value={analyticsData.overview.sessionsCompleted}
                    subtitle={`${analyticsData.sessions.completionRate}% completion rate`}
                    color="indigo"
                />
                <StatCard
                    icon={Target}
                    title="Upcoming Sessions"
                    value={analyticsData.overview.upcomingSessions}
